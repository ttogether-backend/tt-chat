...
import com.wom.ttchat.chatroom.application.port.in.CreateChatUseCase;
...
public class CreateChatService implements CreateChatUseCase {
    ...
    @Override
    public ChatRoomJpaEntity createRoom(CreateChatCommand command, UUID hostId, boolean isGroup) {
